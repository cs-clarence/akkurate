...
class NumberSpec : FunSpec() {
    init {
        ...
        fun `'Float isFinite' fails when the value is infinite`() {
            assertFalse(
                Validatable(Float.POSITIVE_INFINITY).isFinite().satisfied,
                "The constraint is not satisfied when the value is equal to POSITIVE_INFINITY"
            )
            assertFalse(
                Validatable(Float.NEGATIVE_INFINITY).isFinite().satisfied,
                "The constraint is not satisfied when the value is equal to NEGATIVE_INFINITY"
            )
        }
        ...
        fun `'Double isFinite' fails when the value is infinite`() {
            assertFalse(
                Validatable(Double.POSITIVE_INFINITY).isFinite().satisfied,
                "The constraint is not satisfied when the value is equal to POSITIVE_INFINITY"
            )
            assertFalse(
                Validatable(Double.NEGATIVE_INFINITY).isFinite().satisfied,
                "The constraint is not satisfied when the value is equal to NEGATIVE_INFINITY"
            )
        }
        //endregion
        ...
        fun `'Float isInfinite' succeeds when the value is infinite`() {
            assertTrue(
                Validatable(Float.POSITIVE_INFINITY).isInfinite().satisfied,
                "The constraint is satisfied when the value is equal to POSITIVE_INFINITY"
            )
            assertTrue(
                Validatable(Float.NEGATIVE_INFINITY).isInfinite().satisfied,
                "The constraint is satisfied when the value is equal to NEGATIVE_INFINITY"
            )
        }
        ...
        fun `'Double isInfinite' succeeds when the value is infinite`() {
            assertTrue(
                Validatable(Double.POSITIVE_INFINITY).isInfinite().satisfied,
                "The constraint is satisfied when the value is equal to POSITIVE_INFINITY"
            )
            assertTrue(
                Validatable(Double.NEGATIVE_INFINITY).isInfinite().satisfied,
                "The constraint is satisfied when the value is equal to NEGATIVE_INFINITY"
            )
        }
        ...
        fun `'Short isNegative' fails when the value is positive or zero`() {
            assertFalse(
                Validatable((1).toShort()).isNegative().satisfied,
                "The constraint is not satisfied when the value is positive"
            )
            assertFalse(
                Validatable((0).toShort()).isNegative().satisfied,
                "The constraint is not satisfied when the value is zero"
            )
        }
        ...
        fun `'Int isNegative' fails when the value is positive or zero`() {
            assertFalse(
                Validatable(1).isNegative().satisfied,
                "The constraint is not satisfied when the value is positive"
            )
        ...
        fun `'Long isNegative' fails when the value is positive or zero`() {
            assertFalse(
                Validatable(1L).isNegative().satisfied,
                "The constraint is not satisfied when the value is positive"
            )
            assertFalse(
                Validatable(0L).isNegative().satisfied,
                "The constraint is not satisfied when the value is zero"
            )
        }
        ...
        fun `'Float isNegative' fails when the value is positive or zero`() {
            assertFalse(
                Validatable(1f).isNegative().satisfied,
                "The constraint is not satisfied when the value is positive"
            )
            assertFalse(
                Validatable(0f).isNegative().satisfied,
                "The constraint is not satisfied when the value is zero"
            )
        }
        ...
        fun `'Double isNegative' fails when the value is positive or zero`() {
            assertFalse(
                Validatable(1.0).isNegative().satisfied,
                "The constraint is not satisfied when the value is positive"
            )
            assertFalse(
                Validatable(0.0).isNegative().satisfied,
                "The constraint is not satisfied when the value is zero"
            )
        }
        //endregion
        ...
        fun `'Short isNegativeOrZero' succeeds when the value is negative or zero`() {
            assertTrue(
                Validatable((-1).toShort()).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is negative"
            )
            assertTrue(
                Validatable((0).toShort()).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Int isNegativeOrZero' succeeds when the value is negative or zero`() {
            assertTrue(
                Validatable(-1).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is negative"
            )
            assertTrue(
                Validatable(0).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Long isNegativeOrZero' succeeds when the value is negative or zero`() {
            assertTrue(
                Validatable(-1L).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is negative"
            )
            assertTrue(
                Validatable(0L).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Float isNegativeOrZero' succeeds when the value is negative or zero`() {
            assertTrue(
                Validatable(-1f).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is negative"
            )
            assertTrue(
                Validatable(0f).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Double isNegativeOrZero' succeeds when the value is negative or zero`() {
            assertTrue(
                Validatable(-1.0).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is negative"
            )
            assertTrue(
                Validatable(0.0).isNegativeOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Short isPositive' fails when the value is negative or zero`() {
            assertFalse(
                Validatable((-1).toShort()).isPositive().satisfied,
                "The constraint is not satisfied when the value is negative"
            )
            assertFalse(
                Validatable((0).toShort()).isPositive().satisfied,
                "The constraint is not satisfied when the value is zero"
            )
        }
        ...
        fun `'Int isPositive' fails when the value is negative or zero`() {
            assertFalse(
                Validatable(-1).isPositive().satisfied,
                "The constraint is not satisfied when the value is negative"
            )
        ...
        fun `'Long isPositive' fails when the value is negative or zero`() {
            assertFalse(
                Validatable(-1L).isPositive().satisfied,
                "The constraint is not satisfied when the value is negative"
            )
            assertFalse(
                Validatable(0L).isPositive().satisfied,
                "The constraint is not satisfied when the value is zero"
            )
        }
        ...
        fun `'Float isPositive' fails when the value is negative or zero`() {
            assertFalse(
                Validatable(-1f).isPositive().satisfied,
                "The constraint is not satisfied when the value is negative"
            )
            assertFalse(
                Validatable(0f).isPositive().satisfied,
                "The constraint is not satisfied when the value is zero"
            )
        }
        ...
        fun `'Double isPositive' fails when the value is negative or zero`() {
            assertFalse(
                Validatable(-1.0).isPositive().satisfied,
                "The constraint is not satisfied when the value is negative"
            )
            assertFalse(
                Validatable(0.0).isPositive().satisfied,
                "The constraint is not satisfied when the value is zero"
            )
        }
        //endregion
        ...
        fun `'Short isPositiveOrZero' succeeds when the value is positive or zero`() {
            assertTrue(
                Validatable((1).toShort()).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is positive"
            )
            assertTrue(
                Validatable((0).toShort()).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Int isPositiveOrZero' succeeds when the value is positive or zero`() {
            assertTrue(
                Validatable(1).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is positive"
            )
            assertTrue(
                Validatable(0).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Long isPositiveOrZero' succeeds when the value is positive or zero`() {
            assertTrue(
                Validatable(1L).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is positive"
            )
            assertTrue(
                Validatable(0L).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Float isPositiveOrZero' succeeds when the value is positive or zero`() {
            assertTrue(
                Validatable(1f).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is positive"
            )
            assertTrue(
                Validatable(0f).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Double isPositiveOrZero' succeeds when the value is positive or zero`() {
            assertTrue(
                Validatable(1.0).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is positive"
            )
            assertTrue(
                Validatable(0.0).isPositiveOrZero().satisfied,
                "The constraint is satisfied when the value is zero"
            )
        }
        ...
        fun `'Short isLowerThan' fails when the value is greater than or equal to the provided one`() {
            assertFalse(
                Validatable((2).toShort()).isLowerThan(1).satisfied,
                "The constraint is not satisfied when the value is greater than the provided one"
            )
            assertFalse(
                Validatable((2).toShort()).isLowerThan(2).satisfied,
        ...
        fun `'Int isLowerThan' fails when the value is greater than or equal to the provided one`() {
            assertFalse(
                Validatable(2).isLowerThan(1).satisfied,
                "The constraint is not satisfied when the value is greater than the provided one"
            )
            assertFalse(
                Validatable(2).isLowerThan(2).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Long isLowerThan' fails when the value is greater than or equal to the provided one`() {
            assertFalse(
                Validatable(2L).isLowerThan(1).satisfied,
                "The constraint is not satisfied when the value is greater than the provided one"
            )
            assertFalse(
                Validatable(2L).isLowerThan(2).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Float isLowerThan' fails when the value is greater than or equal to the provided one`() {
            assertFalse(
                Validatable(2f).isLowerThan(1f).satisfied,
                "The constraint is not satisfied when the value is greater than the provided one"
            )
            assertFalse(
                Validatable(2f).isLowerThan(2f).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Double isLowerThan' fails when the value is greater than or equal to the provided one`() {
            assertFalse(
                Validatable(2.0).isLowerThan(1.0).satisfied,
                "The constraint is not satisfied when the value is greater than the provided one"
            )
            assertFalse(
                Validatable(2.0).isLowerThan(2.0).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        //endregion
        ...
        fun `'Short isLowerThanOrEqualTo' succeeds when the value is lower than or equal to the provided one`() {
            assertTrue(
                Validatable((2).toShort()).isLowerThanOrEqualTo(3).satisfied,
                "The constraint is satisfied when the value is lower than the provided one"
            )
            assertTrue(
                Validatable((2).toShort()).isLowerThanOrEqualTo(2).satisfied,
        ...
        fun `'Int isLowerThanOrEqualTo' succeeds when the value is lower than or equal to the provided one`() {
            assertTrue(
                Validatable(2).isLowerThanOrEqualTo(3).satisfied,
                "The constraint is satisfied when the value is lower than the provided one"
            )
            assertTrue(
                Validatable(2).isLowerThanOrEqualTo(2).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Long isLowerThanOrEqualTo' succeeds when the value is lower than or equal to the provided one`() {
            assertTrue(
                Validatable(2L).isLowerThanOrEqualTo(3).satisfied,
                "The constraint is satisfied when the value is lower than the provided one"
            )
            assertTrue(
                Validatable(2L).isLowerThanOrEqualTo(2).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Float isLowerThanOrEqualTo' succeeds when the value is lower than or equal to the provided one`() {
            assertTrue(
                Validatable(2f).isLowerThanOrEqualTo(3f).satisfied,
                "The constraint is satisfied when the value is lower than the provided one"
            )
            assertTrue(
                Validatable(2f).isLowerThanOrEqualTo(2f).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Double isLowerThanOrEqualTo' succeeds when the value is lower than or equal to the provided one`() {
            assertTrue(
                Validatable(2.0).isLowerThanOrEqualTo(3.0).satisfied,
                "The constraint is satisfied when the value is lower than the provided one"
            )
            assertTrue(
                Validatable(2.0).isLowerThanOrEqualTo(2.0).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Short isGreaterThan' fails when the value is lower than or equal to the provided one`() {
            assertFalse(
                Validatable((2).toShort()).isGreaterThan(3).satisfied,
                "The constraint is not satisfied when the value is lower than the provided one"
            )
            assertFalse(
                Validatable((2).toShort()).isGreaterThan(2).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Int isGreaterThan' fails when the value is lower than or equal to the provided one`() {
            assertFalse(
                Validatable(2).isGreaterThan(3).satisfied,
                "The constraint is not satisfied when the value is lower than the provided one"
            )
            assertFalse(
                Validatable(2).isGreaterThan(2).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Long isGreaterThan' fails when the value is lower than or equal to the provided one`() {
            assertFalse(
                Validatable(2L).isGreaterThan(3).satisfied,
                "The constraint is not satisfied when the value is lower than the provided one"
            )
            assertFalse(
                Validatable(2L).isGreaterThan(2).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Float isGreaterThan' fails when the value is lower than or equal to the provided one`() {
            assertFalse(
                Validatable(2f).isGreaterThan(3f).satisfied,
                "The constraint is not satisfied when the value is lower than the provided one"
            )
            assertFalse(
                Validatable(2f).isGreaterThan(2f).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Double isGreaterThan' fails when the value is lower than or equal to the provided one`() {
            assertFalse(
                Validatable(2.0).isGreaterThan(3.0).satisfied,
                "The constraint is not satisfied when the value is lower than the provided one"
            )
            assertFalse(
                Validatable(2.0).isGreaterThan(2.0).satisfied,
                "The constraint is not satisfied when the value is equal to the provided one"
            )
        }
        //endregion
        ...
        fun `'Short isGreaterThanOrEqualTo' succeeds when the value is greater than or equal to the provided one`() {
            assertTrue(
                Validatable((2).toShort()).isGreaterThanOrEqualTo(1).satisfied,
                "The constraint is satisfied when the value is greater than the provided one"
            )
            assertTrue(
                Validatable((2).toShort()).isGreaterThanOrEqualTo(2).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Int isGreaterThanOrEqualTo' succeeds when the value is greater than or equal to the provided one`() {
            assertTrue(
                Validatable(2).isGreaterThanOrEqualTo(1).satisfied,
                "The constraint is satisfied when the value is greater than the provided one"
            )
            assertTrue(
                Validatable(2).isGreaterThanOrEqualTo(2).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Long isGreaterThanOrEqualTo' succeeds when the value is greater than or equal to the provided one`() {
            assertTrue(
                Validatable(2L).isGreaterThanOrEqualTo(1).satisfied,
                "The constraint is satisfied when the value is greater than the provided one"
            )
            assertTrue(
                Validatable(2L).isGreaterThanOrEqualTo(2).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Float isGreaterThanOrEqualTo' succeeds when the value is greater than or equal to the provided one`() {
            assertTrue(
                Validatable(2f).isGreaterThanOrEqualTo(1f).satisfied,
                "The constraint is satisfied when the value is greater than the provided one"
            )
            assertTrue(
                Validatable(2f).isGreaterThanOrEqualTo(2f).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Double isGreaterThanOrEqualTo' succeeds when the value is greater than or equal to the provided one`() {
            assertTrue(
                Validatable(2.0).isGreaterThanOrEqualTo(1.0).satisfied,
                "The constraint is satisfied when the value is greater than the provided one"
            )
            assertTrue(
                Validatable(2.0).isGreaterThanOrEqualTo(2.0).satisfied,
                "The constraint is satisfied when the value is equal to the provided one"
            )
        }
        ...
        fun `'Short hasIntegralCountEqualTo' succeeds when the number of digits is equal to the provided one`() {
            assertTrue(
                Validatable((123).toShort()).hasIntegralCountEqualTo(3).satisfied,
                "The constraint is satisfied with a positive number"
            )
            assertTrue(
                Validatable((-123).toShort()).hasIntegralCountEqualTo(3).satisfied,
                "The constraint is satisfied with a negative number"
            )
        }
        ...
        fun `'Int hasIntegralCountEqualTo' succeeds when the number of digits is equal to the provided one`() {
            assertTrue(
                Validatable(123).hasIntegralCountEqualTo(3).satisfied,
                "The constraint is satisfied with a positive number"
            )
            assertTrue(
                Validatable(-123).hasIntegralCountEqualTo(3).satisfied,
        ...
        fun `'Long hasIntegralCountEqualTo' succeeds when the number of digits is equal to the provided one`() {
            assertTrue(
                Validatable(123L).hasIntegralCountEqualTo(3).satisfied,
                "The constraint is satisfied with a positive number"
            )
            assertTrue(
                Validatable(-123L).hasIntegralCountEqualTo(3).satisfied,
        ...
        fun `'Float hasIntegralCountEqualTo' succeeds when the number of digits is equal to the provided one`() {
            assertTrue(
                Validatable(123.45f).hasIntegralCountEqualTo(3).satisfied,
                "The constraint is satisfied with a positive number"
            )
            assertTrue(
                Validatable(-123.45f).hasIntegralCountEqualTo(3).satisfied,
        ...
        fun `'Double hasIntegralCountEqualTo' succeeds when the number of digits is equal to the provided one`() {
            assertTrue(
                Validatable(123.45).hasIntegralCountEqualTo(3).satisfied,
                "The constraint is satisfied with a positive number"
            )
            assertTrue(
                Validatable(-123.45).hasIntegralCountEqualTo(3).satisfied,
