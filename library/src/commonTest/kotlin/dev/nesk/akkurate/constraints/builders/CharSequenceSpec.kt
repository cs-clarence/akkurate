...
class CharSequenceSpec : FunSpec() {
    init {
        //region isEmpty
        @Test
        ...
        fun `'hasLengthLowerThan' fails when the length is greater than or equal to the provided one`() {
            assertFalse(
                Validatable("foo").hasLengthLowerThan(2).satisfied,
                "The constraint is not satisfied when the length is greater than the provided one"
            )
            assertFalse(
                Validatable("foo").hasLengthLowerThan(3).satisfied,
                "The constraint is not satisfied when the length is equal to the provided one"
            )
        }
        //endregion
        ...
        fun `'hasLengthLowerThanOrEqualTo' succeeds when the length is lower than or equal to the provided one`() {
            assertTrue(
                Validatable("foo").hasLengthLowerThanOrEqualTo(4).satisfied,
                "The constraint is satisfied when the length is lower than the provided one"
            )
            assertTrue(
                Validatable("foo").hasLengthLowerThanOrEqualTo(3).satisfied,
                "The constraint is satisfied when the length is equal to the provided one"
            )
        }
        ...
        fun `'hasLengthGreaterThan' fails when the length is lower than or equal to the provided one`() {
            assertFalse(
                Validatable("foo").hasLengthGreaterThan(4).satisfied,
                "The constraint is not satisfied when the length is lower than the provided one"
            )
            assertFalse(
                Validatable("foo").hasLengthGreaterThan(3).satisfied,
                "The constraint is not satisfied when the length is equal to the provided one"
            )
        }
        //endregion
        ...
        fun `'hasLengthGreaterThanOrEqualTo' succeeds when the length is greater than or equal to the provided one`() {
            assertTrue(
                Validatable("foo").hasLengthGreaterThanOrEqualTo(2).satisfied,
                "The constraint is satisfied when the length is greater than the provided one"
            )
            assertTrue(
                Validatable("foo").hasLengthGreaterThanOrEqualTo(3).satisfied,
                "The constraint is satisfied when the length is equal to the provided one"
            )
        }
