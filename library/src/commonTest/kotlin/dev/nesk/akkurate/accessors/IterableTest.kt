...
class IterableTest {
    @Test
    @JsName("iteratorReturnsAnIterableWrappingEachValueOfTheOriginalIterableWithAnIndexedPath")
    ...
    @Test
    @JsName("iteratorReturnsALazyIterableAndValuesAreProcessedOnTheFly")
    ...
    @Test
    @JsName("iteratorReturnsAnEmptyIteratorWhenTheIterableIsNull")
    ...
    @Test
    @JsName("callingEachWillExecuteTheBlockForEachValueOfTheIterableWrappedInValidatableAndPassedAsTheReceiver")
    ...
    @Test
    @JsName("eachNeverExecutesTheBlockWhenTheIterableIsNull")
