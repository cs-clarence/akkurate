...
class ValidatableCompoundTest {
    @Test
    @JsName("aValidatableCompoundIsCreatedWhenUsingTheAndFunctionBetweenTwoValidatables")
    ...
    @Test
    @JsName("aValidatableCompoundIsCreatedWhenUsingTheAndFunctionBetweenACompoundAndAValidatable")
    ...
    @Test
    @JsName("aValidatableCompoundIsCreatedWhenUsingTheAndFunctionBetweenAValidatableAndACompound")
    ...
    @Test
    @JsName("aValidatableCompoundIsCreatedWhenUsingTheAndFunctionBetweenTwoCompounds")
    ...
    @Test
    @JsName("aValidatableCompoundIsCreatedWhenUsingTheAndFunctionBetweenACompoundAndAValidatableAndACompound")
    ...
    @Test
    @JsName("aValidatableCompoundContainingTwoValidatablesWithTheSameValueWillCallTheLambdaTwiceNotJustOnceDueToEqualsImplementation")
