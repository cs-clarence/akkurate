...
class ValidatorSpec : FunSpec() {
    ...
    init {
        ...
        test("a validation with satisfied constraints returns a successful result with the corresponding value") {
            // Arrange
            val value = Value()
        ...
        test("a validation with unsatisfied constraints returns a failed result with the corresponding violations") {
            // Arrange
        ...
        test("a contextual validation with satisfied constraints returns a successful result") {
            // Arrange
        ...
        test("a contextual validation with unsatisfied constraints returns a failed result with the corresponding violations") {
            // Arrange
            val validate = Validator<Context, Nothing?> {
                constrain { false } otherwise { "Bad value" } withPath { absolute("path", "to", "value") }
            }
        ...
        test("an async validation with satisfied constraints returns a successful result") {
            runTest {
                // Arrange
        ...
        test("an async validation with unsatisfied constraints returns a failed result with the corresponding violations") {
            runTest {
                // Arrange
                val validate = Validator.suspendable<Nothing?> {
                    constrain { false } otherwise { "Bad value" } withPath { absolute("path", "to", "value") }
        ...
        test("an async contextual validation with satisfied constraints returns a successful result") {
            runTest {
                // Arrange
        ...
        test("an async contextual validation with unsatisfied constraints returns a failed result with the corresponding violations") {
            runTest {
                // Arrange
                val validate = Validator<Context, Nothing?> {
                    constrain { false } otherwise { "Bad value" } withPath { absolute("path", "to", "value") }
        ...
        test("definining failOnFirstViolation=true in the configuration skips all the upcoming constraints after the first constraint violation") {
            // Arrange
        ...
        test("definining failOnFirstViolation=false in the configuration executes all the constraints before returning a failure") {
            // Arrange
        ...
        test("a composite validation reports all the contraint violations, including the nested ones") {
            // Arrange
            ...
            assertContentEquals(
                ...
                "All the constraints violations are reported"
            )
        }


        test("a contextual composite validation reports all the contraint violations, including the nested ones") {
            // Arrange
        ...
        test("an async composite validation reports all the contraint violations, including the nested ones") {
            runTest {
                // Arrange
        ...
        test("an async contextual composite validation reports all the contraint violations, including the nested ones") {
            runTest {
                // Arrange
